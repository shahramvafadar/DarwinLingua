...
- reusable UI component extraction now includes shared word-list-item, detail-section, CEFR quick-filter, and action-block views applied across home and browse screens
